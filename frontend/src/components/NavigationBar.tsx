  ...
  return (
    <nav className={styles.navigationbar}>
      ...
      <NavItem
        ...
        label="Progress"
        isActive={location.pathname === '/MyProgress.tsx' || location.pathname === '/progress'}
      ...
      <NavItem
        ...
        label="Goals"
        isActive={location.pathname === '/GoalsPlans' || location.pathname === '/goals'}
      ...
      <NavItem
        ...
        label="Menu"
        isActive={location.pathname === '/Menu' || location.pathname === '/menu'}
